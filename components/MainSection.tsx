...
const MainSection = () => {
  return (
    <section className="relative main-background">
      <div className="flex flex-col sm:flex-row relative -top-16 sm:-top-20 md:-top-24 lg:-top-32 justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-10 mx-auto px-4 sm:px-6 md:px-8">
